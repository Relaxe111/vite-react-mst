...
import type { DocRenderer, IConfig, IDocument, ITheme } from "./types";
...
export type {DocRenderer,DocRendererProps,IConfig,IDocument,IHeaderConfig,IHeaderOverride,IStyledProps,ITheme} from "./types";
